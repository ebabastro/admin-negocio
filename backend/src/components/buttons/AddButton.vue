<template>
  <div>
    <button
      v-if="!creating"
      @click="create"
      class="bg-emerald-600 w-full rounded border border-emerald-600 text-white py-1 hover:bg-emerald-500 hover:border-emerald-500 transition-all duration-200 shadow shadow-slate-900/100"
    >
      Agregar
    </button>
    <input
